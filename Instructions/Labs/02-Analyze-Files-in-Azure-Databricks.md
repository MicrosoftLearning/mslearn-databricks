...
2. In the **Import Notebooks** dialog box, select **URL** and import the notebook from `https://github.com/MicrosoftLearning/mslearn-databricks/raw/main/Allfiles/Labs/02/Databricks-Spark.dbc`.
